...
const UserResult = () => {
  ...
  const fetchInterviewResult = async () => {
    try {
      ...
      console.error('Fetch interview result error:', error)
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">{error || 'Interview result could not be loaded'}</p>
          <button
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            {interview.domain} Interview - {new Date(interview.createdAt).toLocaleDateString()}
          </p>
        </div>
        ...
        <div className="card mb-8 bg-gradient-to-r from-primary-50 to-primary-100">
          <div className="text-center">
            ...
            <p className="text-gray-700 max-w-2xl mx-auto">
              Great job! You've completed the interview. Review your detailed feedback below to understand your strengths and areas for improvement.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          <div className="card">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-2xl font-bold text-gray-900">{interview.questionCount || 0}</span>
            </div>
          ...
          <div className="card">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-2xl font-bold text-gray-900">
                {Math.round((interview.totalDuration || 0) / 60)}m
              </span>
            </div>
          ...
          <div className="card">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-2xl font-bold text-gray-900">{interview.questions?.length || 0}</span>
            </div>
            <p className="text-gray-600">Completed Questions</p>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <div className="text-3xl font-bold text-primary-600 mb-2">
                  {interview.skillBreakdown.problemSolving || 0}%
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div 
                    className="bg-primary-600 h-2 rounded-full"
                    style={{ width: `${interview.skillBreakdown.problemSolving || 0}%` }}
                  />
                </div>
              </div>
              <div className="text-center">
                ...
                <div className="text-3xl font-bold text-success-600 mb-2">
                  {interview.skillBreakdown.aiKnowledge || 0}%
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div 
                    className="bg-success-600 h-2 rounded-full"
                    style={{ width: `${interview.skillBreakdown.aiKnowledge || 0}%` }}
                  />
                </div>
              </div>
              <div className="text-center">
                ...
                <div className="text-3xl font-bold text-warning-600 mb-2">
                  {interview.skillBreakdown.communication || 0}%
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div 
                    className="bg-warning-600 h-2 rounded-full"
                    style={{ width: `${interview.skillBreakdown.communication || 0}%` }}
                  />
                </div>
              </div>
            </div>
                ...
                <div key={index} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 text-sm mb-2">Your answer: {question.answer}</p>
